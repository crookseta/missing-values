...
namespace MissingValues.Benchmarks.Core
{
	public class UInt512Benchmarks
	{
		...
		public class MathOperators
		{
			...
			{
				yield return [rng.NextIntegerArray<UInt512>(MaxLength, new UInt512(1, 0, 0, 0, 0, 0, 0, 0), UInt512.MaxValue), rng.NextIntegerArray<UInt512>(MaxLength, ulong.MaxValue)];
			}
			public IEnumerable<object[]> Arguments512x128()
			{
				yield return [rng.NextIntegerArray<UInt512>(MaxLength, new UInt512(1, 0, 0, 0, 0, 0, 0, 0), UInt512.MaxValue), rng.NextIntegerArray<UInt512>(MaxLength, new UInt256(0, 0, 1, 0), UInt128.MaxValue)];
			}
			public IEnumerable<object[]> Arguments512x256()
			{
				yield return [rng.NextIntegerArray<UInt512>(MaxLength, new UInt512(1, 0, 0, 0, 0, 0, 0, 0), UInt512.MaxValue), rng.NextIntegerArray<UInt512>(MaxLength, new UInt256(1, 0, 0, 0), UInt256.MaxValue)];
			}
			public IEnumerable<object[]> Arguments512x512()
			{
				yield return [rng.NextIntegerArray<UInt512>(MaxLength, new UInt512(1, 0, 0, 0, 0, 0, 0, 0), UInt512.MaxValue), rng.NextIntegerArray<UInt512>(MaxLength, new UInt512(1, 0, 0, 0, 0, 0, 0, 0), UInt512.MaxValue)];
			}
			public IEnumerable<object[]> Arguments256x512()
			{
				yield return [rng.NextIntegerArray<UInt512>(MaxLength, new UInt256(1, 0, 0, 0), UInt256.MaxValue), rng.NextIntegerArray<UInt512>(MaxLength, new UInt512(1, 0, 0, 0, 0, 0, 0, 0), UInt512.MaxValue)];
			}
			public IEnumerable<object[]> Arguments128x512()
			{
				yield return [rng.NextIntegerArray<UInt512>(MaxLength, new UInt256(0, 0, 1, 0), UInt128.MaxValue), rng.NextIntegerArray<UInt512>(MaxLength, new UInt512(1, 0, 0, 0, 0, 0, 0, 0), UInt512.MaxValue)];
			}
			public IEnumerable<object[]> Arguments64x512()
			{
				yield return [rng.NextIntegerArray<UInt512>(MaxLength, ulong.MaxValue), rng.NextIntegerArray<UInt512>(MaxLength, new UInt512(1, 0, 0, 0, 0, 0, 0, 0), UInt512.MaxValue)];
			}
		}
