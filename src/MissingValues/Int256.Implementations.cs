...
namespace MissingValues
{
		...
		IFormattableSignedInteger<Int256, UInt256>
	{
		...
		public static bool TryParse(ReadOnlySpan<char> s, NumberStyles style, IFormatProvider? provider, [MaybeNullWhen(false)] out Int256 result)
		{
			...
			return NumberParser.TryParseToSigned<Int256, UInt256>(s, style, provider, out result);
		}
		...
		public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, [MaybeNullWhen(false)] out Int256 result)
		{
			...
			return NumberParser.TryParseToSigned<Int256, UInt256>(s, NumberStyles.Integer, provider, out result);
		}
		...
		{
			return NumberFormatter.TryFormatSignedNumber<Int256, UInt256>(in this, destination, out charsWritten, format, provider);
		}
