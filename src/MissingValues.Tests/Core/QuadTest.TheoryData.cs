...
#pragma warning disable S3263 // Static fields should appear in the order they must be initialized 
		private static (string, bool, Quad)[] _tryParseData =
		{
			...
			("256,4995", true, Values.CreateQuad(0x4007_007F_DF3B_645A, 0x1CAC_0831_26E9_78D5)),
			("471581881", true, Values.CreateQuad(0x401B_C1BC_4B90_0000, 0x0000_0000_0000_0000)),
			("1,93561113", true, Values.CreateQuad(0x3FFF_EF84_3605_1FA4, 0x8B0F_3D34_BECE_8762)),
			("9715574,2", true, Values.CreateQuad(0x4016_287E_EC66_6666, 0x6666_6666_6666_6666)),
			("0,51438427732005011792", true, Values.CreateQuad(0x3FFE_075D_6041_5519, 0x72D0_0AD3_7DB4_57E9)),
			("0,04201133209656899095", true, Values.CreateQuad(0x3FFA_5828_262D_512C, 0x8840_B3B3_D424_5947)),
			("7,7E777", true, Values.CreateQuad(0x4A17_0F28_5D1D_4C84, 0xA11F_6899_101B_A9A4)),
			("-7,7E-777", true, Values.CreateQuad(0xB5EC_BFCE_3AF6_4E08, 0x42C8_5750_BEBD_A572)),
			("1A", false, default),
		};
		...
		{
			(Values.CreateQuad(0x4000_C000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.AwayFromZero, Four),
			(Values.CreateQuad(0x4000_6666_6666_6666, 0x6666_6666_6666_6666), 0, MidpointRounding.AwayFromZero, Three),
			(Values.CreateQuad(0x4000_4000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.AwayFromZero, Three),
			(Values.CreateQuad(0x4000_0CCC_CCCC_CCCC, 0xCCCC_CCCC_CCCC_CCCD), 0, MidpointRounding.AwayFromZero, Two),
			(Values.CreateQuad(0xC000_0CCC_CCCC_CCCC, 0xCCCC_CCCC_CCCC_CCCD), 0, MidpointRounding.AwayFromZero, NegativeTwo),
			(Values.CreateQuad(0xC000_4000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.AwayFromZero, NegativeThree),
			(Values.CreateQuad(0xC000_6666_6666_6666, 0x6666_6666_6666_6666), 0, MidpointRounding.AwayFromZero, NegativeThree),
			(Values.CreateQuad(0xC000_C000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.AwayFromZero, NegativeFour),
		};
		private static (Quad, int, MidpointRounding, Quad)[] _roundToEvenData =
		{
			(Values.CreateQuad(0x4000_C000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToEven, Four),
			(Values.CreateQuad(0x4000_6666_6666_6666, 0x6666_6666_6666_6666), 0, MidpointRounding.ToEven, Three),
			(Values.CreateQuad(0x4000_4000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToEven, Two),
			(Values.CreateQuad(0x4000_0CCC_CCCC_CCCC, 0xCCCC_CCCC_CCCC_CCCD), 0, MidpointRounding.ToEven, Two),
			(Values.CreateQuad(0xC000_0CCC_CCCC_CCCC, 0xCCCC_CCCC_CCCC_CCCD), 0, MidpointRounding.ToEven, NegativeTwo),
			(Values.CreateQuad(0xC000_4000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToEven, NegativeTwo),
			(Values.CreateQuad(0xC000_6666_6666_6666, 0x6666_6666_6666_6666), 0, MidpointRounding.ToEven, NegativeThree),
			(Values.CreateQuad(0xC000_C000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToEven, NegativeFour),
		};
		private static (Quad, int, MidpointRounding, Quad)[] _roundToNegativeInfinityData =
		{
			(Values.CreateQuad(0x4000_C000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToNegativeInfinity, Three),
			(Values.CreateQuad(0x4000_6666_6666_6666, 0x6666_6666_6666_6666), 0, MidpointRounding.ToNegativeInfinity, Two),
			(Values.CreateQuad(0x4000_4000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToNegativeInfinity, Two),
			(Values.CreateQuad(0x4000_0CCC_CCCC_CCCC, 0xCCCC_CCCC_CCCC_CCCD), 0, MidpointRounding.ToNegativeInfinity, Two),
			(Values.CreateQuad(0xC000_0CCC_CCCC_CCCC, 0xCCCC_CCCC_CCCC_CCCD), 0, MidpointRounding.ToNegativeInfinity, NegativeThree),
			(Values.CreateQuad(0xC000_4000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToNegativeInfinity, NegativeThree),
			(Values.CreateQuad(0xC000_6666_6666_6666, 0x6666_6666_6666_6666), 0, MidpointRounding.ToNegativeInfinity, NegativeThree),
			(Values.CreateQuad(0xC000_C000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToNegativeInfinity, NegativeFour),
		};
		private static (Quad, int, MidpointRounding, Quad)[] _roundToPositiveInfinityData =
		{
			(Values.CreateQuad(0x4000_C000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToPositiveInfinity, Four),
			(Values.CreateQuad(0x4000_6666_6666_6666, 0x6666_6666_6666_6666), 0, MidpointRounding.ToPositiveInfinity, Three),
			(Values.CreateQuad(0x4000_4000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToPositiveInfinity, Three),
			(Values.CreateQuad(0x4000_0CCC_CCCC_CCCC, 0xCCCC_CCCC_CCCC_CCCD), 0, MidpointRounding.ToPositiveInfinity, Three),
			(Values.CreateQuad(0xC000_0CCC_CCCC_CCCC, 0xCCCC_CCCC_CCCC_CCCD), 0, MidpointRounding.ToPositiveInfinity, NegativeTwo),
			(Values.CreateQuad(0xC000_4000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToPositiveInfinity, NegativeTwo),
			(Values.CreateQuad(0xC000_6666_6666_6666, 0x6666_6666_6666_6666), 0, MidpointRounding.ToPositiveInfinity, NegativeTwo),
			(Values.CreateQuad(0xC000_C000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToPositiveInfinity, NegativeThree),
		};
		private static (Quad, int, MidpointRounding, Quad)[] _roundToZeroData =
		{
			(Values.CreateQuad(0x4000_C000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToZero, Three),
			(Values.CreateQuad(0x4000_6666_6666_6666, 0x6666_6666_6666_6666), 0, MidpointRounding.ToZero, Two),
			(Values.CreateQuad(0x4000_4000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToZero, Two),
			(Values.CreateQuad(0x4000_0CCC_CCCC_CCCC, 0xCCCC_CCCC_CCCC_CCCD), 0, MidpointRounding.ToZero, Two),
			(Values.CreateQuad(0xC000_0CCC_CCCC_CCCC, 0xCCCC_CCCC_CCCC_CCCD), 0, MidpointRounding.ToZero, NegativeTwo),
			(Values.CreateQuad(0xC000_4000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToZero, NegativeTwo),
			(Values.CreateQuad(0xC000_6666_6666_6666, 0x6666_6666_6666_6666), 0, MidpointRounding.ToZero, NegativeTwo),
			(Values.CreateQuad(0xC000_C000_0000_0000, 0x0000_0000_0000_0000), 0, MidpointRounding.ToZero, NegativeThree),
		};
