...
public static class Int512Extensions
{
	extension(Int512)
	{
		private static Int512 SByteMaxValue => new(
		...
		private static Int512 SByteMinValue => new(
